...
CREATE TABLE ISSUE (
    ...
    IssueMessage VARCHAR(300) NOT NULL,
    IssueImage url,
...
CREATE TABLE PROPERTY_REVIEW (
    ...
    ReviewTimeStamp TIMESTAMP(6) NOT NULL,
    Image url,
...
CREATE TABLE PROPERTY_LISTING (
    ...
    PropertyListTimeStamp TIMESTAMP(6) NOT NULL
);
...
CREATE TABLE APPOINTMENT (
    ...
    DwellerEmail VARCHAR(319) REFERENCES DWELLER(DwellerEmail) NOT NULL,
    AppointmentTimeStamp TIMESTAMP(6) NOT NULL,
...
CREATE TABLE PROPERTY_LISTING_FOR_RENT (
    PropertyId VARCHAR(36) PRIMARY KEY REFERENCES PROPERTY_LISTING(PropertyId) NOT NULL,
    PricePerMonth FLOAT(24) NOT NULL,
...
CREATE TABLE RENT (
    ...
    RentStartDate TIMESTAMP(0) NOT NULL,
    PRIMARY KEY (PropertyId, DwellerEmail)
);
